...
<form class="form form-horizontal" action="{{route('dashboard.users.store')}}" method="post" enctype="multipart/form-data">
    @csrf
  <div class="form-body">
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <div class="position-relative has-icon-left">
          <input  name="firstName" class="form-control" type="text" id="firstName" placeholder="Type Yout First Name" value="{{old('firstName')}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
          <div class="position-relative has-icon-left">
            <input name="lastName" class="form-control" type="text" id="lastName" placeholder="Type your Last Name" value="{{old('lastName')}}">
            <div class="form-control-position pl-1"><i class="la la-user"></i></div>
          </div>
        </div>
      </div>
    ...
    <div class="form-group row">
      <label class="col-sm-3 form-control-label" for="avatar">{{__('static.avatar')}}</label>
      <div class="col-sm-9">
        <div class="position-relative has-icon-left">
          <input name="avatar" class="form-control" type="file" id="avatar"  value="{{old('avatar')}}">
          <div class="form-control-position pl-1"><i class="la la-photo"></i></div>
        </div>
      </div>
    </div>
