    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        @endif
         ...
         <li class=" nav-item"><a href="{{route('dashboard.categories.index')}}"><i class="la la-user"></i>{{__('adminSidebar.categories')}}</a>
          @endif
          @if (auth()->user()->hasPermission('product_read'))
          <li class=" nav-item"><a href="{{route('dashboard.products.index')}}"><i class="la la-user"></i>{{__('adminSidebar.products')}}</a>
          @endif
