  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="{{route('dashboard.home')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.templates.main">{{__('adminSidebar.dashboard')}}</span></a>

        </li>
        @if (auth()->user()->hasPermission('users_read'))
          <li class=" nav-item"><a href="{{route('dashboard.users.index')}}"><i class="la la-user"></i>{{__('adminSidebar.users')}}</a>
        @endif
        </li>
      </li>

         @if (auth()->user()->hasPermission('categories_read'))    
         <li class=" nav-item"><a href="{{route('dashboard.categories.index')}}"><i class="la la-tag"></i>{{__('adminSidebar.categories')}}</a>
          @endif
          @if (auth()->user()->hasPermission('product_read'))
          <li class=" nav-item"><a href="{{route('dashboard.products.index')}}"><i class="la la-cart-plus"></i>{{__('adminSidebar.products')}}</a>
          @endif
          @if (auth()->user()->hasPermission('clients_read'))
          <li class=" nav-item"><a href="{{route('dashboard.clients.index')}}"><i class="la la-users"></i>{{__('adminSidebar.clients')}}</a>
          @endif
